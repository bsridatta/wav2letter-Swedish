...
execute_process(
  COMMAND "/usr/bin/git" show-ref 2fe3bd994b3189899d93f1d5a881e725e046fdc2
  WORKING_DIRECTORY "/root/wav2letter/build/src/tests/googletest/src/gtest"
...
if("${show_ref_output}" MATCHES "refs/remotes/2fe3bd994b3189899d93f1d5a881e725e046fdc2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "2fe3bd994b3189899d93f1d5a881e725e046fdc2")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "2fe3bd994b3189899d93f1d5a881e725e046fdc2")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 2fe3bd994b3189899d93f1d5a881e725e046fdc2
  WORKING_DIRECTORY "/root/wav2letter/build/src/tests/googletest/src/gtest"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/wav2letter/build/src/tests/googletest/src/gtest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/root/wav2letter/build/src/tests/googletest/src/gtest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout 2fe3bd994b3189899d93f1d5a881e725e046fdc2
      WORKING_DIRECTORY "/root/wav2letter/build/src/tests/googletest/src/gtest"
      RESULT_VARIABLE error_code
      )
    if(error_code)
